return {
  ...
  keys = {
    ...
    -- git
    { "<leader>gb", function() Snacks.picker.git_branches({ layout = "ivy" }) end, desc = "Git Branches" },
    { "<leader>gl", function() Snacks.picker.git_log({ layout = "ivy" }) end, desc = "Git Log" },
    { "<leader>gL", function() Snacks.picker.git_log_line({ layout = "ivy" }) end, desc = "Git Log Line" },
    { "<leader>gs", function() Snacks.picker.git_status({ layout = "ivy" }) end, desc = "Git Status" },
    { "<leader>gS", function() Snacks.picker.git_stash({ layout = "ivy" }) end, desc = "Git Stash" },
    ...
    { "<leader>fc", function() Snacks.picker.grep_word({ layout = "ivy" }) end, desc = "Visual selection or word", mode = { "n", "x" } },
    -- search
    ...
    { "<leader>sl", function() Snacks.picker.picker_layouts() end, desc = "Pickers list" },
